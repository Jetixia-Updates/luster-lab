...
import {
  ...
  Stethoscope, Users, ScrollText, FileText, Bell, AlertTriangle, QrCode, Fingerprint, Briefcase,
} from "lucide-react";
import {
...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/finishing", label: "البورسلين", icon: Paintbrush, roles: ["admin", "technician"] },
  ...
  },
  {
    title: "إدارة",
    items: [
      { path: "/hr", label: "الموارد البشرية", icon: Briefcase, roles: ["admin"] },
